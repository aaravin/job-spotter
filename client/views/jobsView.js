...
var JobsList = React.createClass({
  ...
  render: function() {
    ...
    if (this.props.location !== null && this.props.title !== null && this.props.location !== '' && this.props.title === '') {
      titleString = '' + count.toLocaleString() + (count===1 ? ' job ' : ' jobs ') + 'found in ' + this.props.location.toUpperCase();
    } else if (this.props.location !== null && this.props.title !== null && this.props.location === '' && this.props.title !== '') {
